                    ...
                    <div className="top-row d-flex align-items-center justify-content-between">
                        ...
                        <div className="top-actions d-flex align-items-center gap-2">
                            ...
                            <div className="action-wrap" style={{ position: 'relative' }}>
                                <button className="icon-btn" onClick={() => { setShowProfile(s => !s); setShowNotif(false); setShowMessages(false); }} aria-label="profile">
                                    <FaUser />
                                </button>
                                {showProfile && (
                            ...
                            <div className="action-wrap" style={{ position: 'relative' }}>
                                <button className="icon-btn" onClick={() => { setShowNotif(s => !s); setShowProfile(false); setShowMessages(false); }} aria-label="notifications">
                                    <FaBell />
                                ...
                                {showNotif && (
                                    <div className="dropdown-panel">
                                        <div className="dropdown-card">
                                            ...
                                            <div className="dropdown-item small text-muted">Propriété approuvée</div>
                                        </div>
                                    </div>
                                )}
                            </div>
                            ...
                            <div className="action-wrap" style={{ position: 'relative' }}>
                                <button className="icon-btn" onClick={() => { setShowMessages(s => !s); setShowProfile(false); setShowNotif(false); }} aria-label="messages">
                                    <FaEnvelope />
                                </button>
                                {showMessages && (
                                    <div className="dropdown-panel">
                            ...
                            <button className="icon-btn danger" onClick={() => { /* placeholder logout */ navigate('/'); }} aria-label="logout"><FaSignOutAlt /></button>
                        </div>
                    </div>
